...
auto FileSystem::GetRelativeFromPath(const std::string & absolute_path) -> const std::string
{
	...
	//ex) C:\Users\User\Desktop\D3D_Framework\Day16에서 
...
auto FileSystem::GetParentDirectory(const std::string & path) -> const std::string
{
	...
	//ex) C:\Users\User\Desktop\D3D_Framework\ -> 인자로 받은 path의 마지막 문자가 \일 경우 
	...
	//위의 두 조건에 충족하지 않은 경우
	//ex) C:\Users\User\Desktop\D3D_Framework -> 인자로 받은 path의 마지막 문자가 \가 아닌 경우
